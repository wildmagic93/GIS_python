...
lakes = ['lake_poma', 'lake_rubino', 'lake_trinita', 'lake_arancio', 'lake_giovanni', 'lake_villarosa', 'lake_nicoletti', 'lake_comunelli', 'lake_disueri']
lakes_labels = ['poma', 'rubino', 'trinita', 'arancio', 'giovanni', 'villarosa', 'nicoletti', 'comunelli', 'disueri']
...
f = open('output.csv', 'w')
f.write('Lake,Month,tilt_max,tilted_ghi_max\n')
for key, value in lakes_max_irradiances.items():
